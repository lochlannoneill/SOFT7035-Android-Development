...
//
        final Button buttonRegister = this.findViewById(R.id.button_register);
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityRegister.this.startActivity(new Intent(ActivityRegister.this, MainActivity.class));
